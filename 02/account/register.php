<?php
	...
	if (isset($_POST['register']))
	{
		...
		if (mysqli_num_rows($result_validate) == 0)
		{
			...
			$mail->Body = "Welcome, $fn $ln ($sid)!<br/>
			...
			<div class="col-lg-offset-3 col-lg-6">
				...
				<form method="POST" class="form-horizontal well">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input name="sid" type="number" class="form-control" maxlength="8" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input name="email" type="email" class="form-control" maxlength="100" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input name="pw" type="password" class="form-control" maxlength="30" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input name="fn" type="text" class="form-control" maxlength="50" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input name="ln" type="text" class="form-control" maxlength="30" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input name="mob" type="number" class="form-control" maxlength="11" required>
						</div>
					</div>
